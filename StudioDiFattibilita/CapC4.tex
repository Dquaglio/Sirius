...
\begin{itemize}
\item Gli strumenti da utilizzare (HTML5\ped{G}, Javascript\ped{G}, database\ped{G}) per lo svolgimento del progetto sono di forte interesse da parte di tutti i componenti del gruppo;
\item Lo studio del concetto di \textbf{\textit{workflow}}\ped{G}, della creazione, validazione, verifica di passi \textbf{\textit{step by step}}\ped{G} dipendenti, considerando la sua relazione con la gestione del lavoro in team;
...
\item Essendo HTML5\ped{G} uno standard non completamente supportato, si corre il rischio di scrivere codice vincolato solamente all'utilizzo dei browser in grado di supportarlo;
...
Dal capitolato si evince che il prodotto andrà ad inserirsi all'interno del mercato del mondo mobile, mercato tuttora in espansione anche se in parte già saturo. Sviluppare quindi un applicazione multi-piattaforma grazie ad HTML5\ped{G} garantirebbe ad essa una maggior probabilità di essere conosciuta.
