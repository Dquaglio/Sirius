...
\item L'utente può effettuare il \textit{login} e diventare autenticato;
\end{itemize}
...
\item L'utente autenticato può effettuare il \textit{logout} diventando utente generico.
\end{itemize}
%\item \textbf{Scenario alternativo:}
%\item \textbf{Inclusioni:}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale:}
	\begin{itemize}
		\item L'utente visualizza il suo \textit{username};
		...
		\item L'utente visualizza la sua \textit{email}.
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item L'utente può modificare la sua \textit{password};
		...
		\item L'utente può modificare la sua \textit{email}.
	\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale:}
	\begin{itemize}
		\item L'utente inserisce la \textit{password} attualmente salvata;
		\item L'utente inserisce la nuova \textit{password} scelta.
	\end{itemize}
	\item \textbf{Scenario alternativo:}
	\begin{itemize}
...
\includegraphics[trim=0cm 0.8cm 0cm 0cm,clip=true,scale=0.75]%
{./grafici/L2444}
\caption{UCL 2.4.4.4: Invio dei dati richiesti}
\end{figure}
\begin{itemize}
\item \textbf{Attori:} Utente autenticato;
...
\bookmark[dest=L2.4.4.4.1,level=5]{UCL 2.4.4.4.1: Invio di dati testuali}
...
\hypertarget{L2.4.4.4.2}{}
\bookmark[dest=L2.4.4.4.2,level=5]{UCL 2.4.4.4.2: Invio di immagini}
...
\bookmark[dest=L2.4.4.4.3,level=5]{UCL 2.4.4.4.3: Invio di dati numerici}
...
\bookmark[dest=L2.4.4.4.4,level=5]{UCL 2.4.4.4.4: Invio della posizione geografica}
\subsubsection{UCL 2.4.4.4.4: Invio della posizione geografica}
\begin{itemize}
\item \textbf{Attori:} Utente autenticato;
...
\bookmark[dest=L2.4.4.4.5,level=5]{UCL 2.4.4.4.5: Invio della data e dell'ora}
...
\hypertarget{L2.4.4.7}{}
\bookmark[dest=L2.4.4.7,level=5]{UCL 2.4.4.7: Salto di un passo}
...
\bookmark[dest=L2.4.5.1,level=5]{UCL 2.4.5.1: Creazione report finale}
\subsubsection{UCL 2.4.5.1: Creazione report finale}
\begin{figure}[H]
\centering
\includegraphics[trim=0cm 0.8cm 0cm 0cm,clip=true,scale=0.75]%
{./grafici/L2451}
\caption{UCL 2.4.5.1: Creazione report finale}
\end{figure}
\begin{itemize}
\item \textbf{Attori:} Utente autenticato;
...
\bookmark[dest=L2.4.5.1.1,level=5]{UCL 2.4.5.1.1: Visualizzazione del report finale}
...
\bookmark[dest=L2.4.5.1.2,level=5]{UCL 2.4.5.1.2: Salvataggio del report finale}
