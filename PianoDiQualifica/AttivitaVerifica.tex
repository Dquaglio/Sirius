...
\textbf{Metrica} & \textbf{Media} & \textbf{Massimo} & \textbf{Accettazione}\\
\toprule
Complessità ciclomatica & 4 & 13 & Accettato\\%1-15
\midrule
Livelli di annidamento & 1,46 & 3 & Accettato\\%1-6
\midrule
Attributi per classe & 3,1 & 8 & Accettato\\%0-16
\midrule
Parametri per metodo & 4 & 9 & Accettato\\%0-8
\midrule
Linee di codice per linee commento & 37\% & 48\% & Accettato\\%>0,25
\midrule
Copertura & 82\% &  & \textbf{Accettato}\\%80 percento
\bottomrule
\caption{Risultati delle misurazioni sul codice}
\end{longtable}
