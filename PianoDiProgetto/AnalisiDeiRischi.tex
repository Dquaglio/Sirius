...
\subsubsection{Tempi delle attività}
	...
	\item \textbf{Probabilità di occorrenza:} Media;
	\item \textbf{Grado di pericolosità:} Medio;
	\item \textbf{Strategia di mitigazione: }Si è deciso che per ogni attività la cui terminazione in ritardo crei molti disagi e un aumento eccessivo dei costi si aggiungerà un periodo di slack\ped{G}.
	\end{itemize}
