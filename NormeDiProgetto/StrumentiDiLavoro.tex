...
\subsection{Strumento per la gestione del progetto}
...
\subsection{Strumento di pianificazione}
...
\end{itemize}
\subsection{Strumento di versionamento}
...
\subsection{Strumenti per la condivisione file}
