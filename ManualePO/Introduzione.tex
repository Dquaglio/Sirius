...
Il presente documento ha lo scopo di descrivere le principali funzionalità e il corretto utilizzo del prodotto \textit{software\ped{G}} \progetto{} all'utente \textit{process owner\ped{G}}, ed é suddiviso nelle seguenti sezioni:
...
\begin{itemize}
\item \textbf{Utente base:} può iscriversi ai processi disponibili e completarli eseguendone i passi\ped{G};
